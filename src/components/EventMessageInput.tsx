...
interface EventMessageInputProps {
...
export default function EventMessageInput({ onOptimisticMessage, replyTo, onCancelReply, onTyping }: EventMessageInputProps) {

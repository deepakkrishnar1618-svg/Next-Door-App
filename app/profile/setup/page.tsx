...
import { getCharacterAvatar } from "@/src/utils/avatars";
        ...
        <div className="bg-white/95 dark:bg-dark-surface/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 dark:border-slate-700">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-500 dark:text-slate-400 mt-2 font-outfit">{avatarFile ? "Click to change picture" : "Click to upload custom picture (optional)"}</p>
            </div>
            <div>
